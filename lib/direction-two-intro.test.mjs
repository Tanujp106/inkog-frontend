...
test("keeps direction two mark hover as a lightweight magnetic highlight and shimmer", () => {
...
test("keeps mark magnetism from rereading layout and repainting every hover frame", () => {
  ...
  assert.match(css, /data-mark-magnet-active="true"\] \.direction-two-mark-pixel-active \{[\s\S]*transition:\s*transform 72ms var\(--ease-out-strong\)/);
});
