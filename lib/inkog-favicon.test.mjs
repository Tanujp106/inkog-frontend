...
import { inkogThemeColors } from "./inkog-theme.mjs";
import {
...
test("shares the theme color source with the dynamic app palette", () => {
  assert.strictEqual(inkogFaviconThemeColors, inkogThemeColors);
});
